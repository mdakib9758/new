...
public class Viewbooks extends javax.swing.JFrame {
        ...
        try {
            pst=con.prepareStatement(q);
             ResultSet rs=pst.executeQuery();
                bk.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (SQLException ex) {
    ...
    private void initComponents() {
        ...
        bk = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        bk.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        a.setViewportView(bk);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(a, javax.swing.GroupLayout.DEFAULT_SIZE, 556, Short.MAX_VALUE)
        );
